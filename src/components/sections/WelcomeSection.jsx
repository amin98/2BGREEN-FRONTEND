...
import ForestBackground from '../../assets/forest_background.gif'; // Updated import path for ForestBackground
...
const WelcomeSection = ({ handleScrollDown }) => {
  ...
  return (
    <div className='relative flex justify-center items-center h-[calc(100vh-var(--navbar-height))] md:h-[calc(60vh-var(--navbar-height))]'>
      <SectionLayout className='z-10 w-full mx-10'>
        ...
        <div className='flex-row items-center justify-between hidden w-full lg:flex'>
          ...
          <motion.div
            className='flex flex-col items-start text-pretty lg:w-full'
            initial='hidden'
            animate='visible'
          ...
          <motion.div
            className='flex-col hidden p-1 rounded-lg xl:flex xl:w-3/3'
            initial='hidden'
            animate='visible'
          ...
          >
            ...
            <p className='mb-4 text-lg text-white '>
              ...
              nieuwe producten en tips voor een groenere levensstijl. Meld je
              aan en profiteer!
            </p>
